/**
 * @Package: Crypto Template & Dashboard
 * @Version: 1.0.0
 */
...
jQuery(function($) {
    ...
    //                     "I am really interested in buying bitcoin and other Cryptocurrency",
    //                     "receive",
    //                     name
    //                 );
    //                 msg += chatformat_msg(
    ...
    //             if (
    //                 !$(".chatapi-windows #user-window" + id).hasClass(
    //                     "minimizeit"
    //                 )
    //             ) {
    //                 $(".chatapi-windows #user-window" + id).addClass(
    //                     "minimizeit"
    //                 );
    //                 CRYPTOKIT_SETTINGS.tooltipsPopovers();
    //             } else {
    //                 $(".chatapi-windows #user-window" + id).removeClass(
    //                     "minimizeit"
    //                 );
    //             }
    //         }
    ...
    CRYPTOKIT_SETTINGS.pageTopBar = function() {
        $(".page-topbar li.searchform .input-group-addon").on("click", function(
            e
        ) {
            $(this)
                .parent()
    ...
    CRYPTOKIT_SETTINGS.dataTablesInit = function() {
        if ($.isFunction($.fn.dataTable)) {
            ...
            $.extend(true, $.fn.dataTable.defaults, {
                sDom:
                    "<'row'<'col-md-6'l><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
            ...
            $(document).ready(function() {
                ...
                tableElement.dataTable({
                    sDom:
                        "<'row'<'col-md-6'l T><'col-md-6'f>r>t<'row'<'col-md-12'p i>>",
                    oTableTools: {
                        aButtons: [
                            {
                                sExtends: "collection",
            ...
            for (x = 0; x < colors.length; x++) {
                ...
                $("input.skin-line" + colors[x]).each(function() {
                    ...
                    self.iCheck({
                        ...
                        radioClass: "iradio_line" + colors[x],
                        insert:
                            '<div class="icheck_line-icon"></div>' + label_text
                    });
                });
            } // end for loop
        }
            ...
            $("[data-mask]").each(function(i, el) {
                var $this = $(el),
                    ...
                    opts = {
                        ...
                        rightAlign:
                            getValue($this, "numericAlign", "left") == "right"
                    },
        ...
        if ($.isFunction($.fn.typeahead)) {
            ...
            $("#typeahead-4")
                ...
                .on("keyup", function() {
                    $(this)
                        .data("ttTypeahead")
                        .dropdown.$menu.perfectScrollbar("update");
                });
        }
        /*------------------------------------*/
